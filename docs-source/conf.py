...
import sys
import os
import cloudmesh.workflow_draft
...
version = cloudmesh.workflow.full_version
# The full version, including alpha/beta/rc tags.
release = cloudmesh.workflow.full_version
...
latex_documents = [
    (master_doc, 'cloudmesh.workflow.tex', u'Cloudmesh Workflow Documentation',
...
intersphinx_mapping= {'python': ('https://docs.python.org/', None),
                      'futures':
                      ('https://pythonhosted.org/futures/', None),
                      'networkx':
